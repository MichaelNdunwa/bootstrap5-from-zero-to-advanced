...
![AuroraTours Website Preview](./website_snapshot.png)
...
1. Clone this repo:
   ...
   ```bash
   git clone https://www.github.com/michaelndunwa/bootstrap5-from-zero-to-advanced --depth 1 --branch aurora-tours --single-branch .
   ```
